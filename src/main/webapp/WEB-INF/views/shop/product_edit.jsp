...
function product_delete(){
	if(confirm("삭제하시겠습니까?")){
		document.form1.action="/SpringProject/shop/product/delete.do"
...
<table>
	...
	<tr>
		<td>상품이미지</td>
		<td>
			<img src="/SpringProject/images/${dto.filename}" width="300px" height="300px">
	...
	<tr>
		<td colspan="2" align="center">
			...
			<input type="button" value="목록" onclick="location.href='/SpringProject/shop/product/list.do'">
		</td>
	</tr>
</table>
</form>

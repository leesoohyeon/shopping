package com.spring.project.controller.shop;
...
import com.spring.project.model.shop.ProductDAO;
import com.spring.project.model.shop.ProductDTO;
	...
	public String insert(ProductDTO dto, HttpServletRequest request) {
		...
		if(!dto.getFile1().isEmpty()) {
			...
			try {
				...
				String path = application.getRealPath("/WEB-INF/views/imges/");
				new File(path).mkdir();
